...
<div class="page-container">
	...
	<div class="page-content-wrapper">
		<div class="page-content">
			...
			<div class="row">
				<div class="col-md-12">
					<form class="form-horizontal form-row-seperated" method="post" action="ecommerce_menu_edit.php<?=isset($id)? '?id='.$id : ''?>" enctype="multipart/form-data">
						<div class="portlet light">
								<div class="portlet-title">
									...
									<div class="actions btn-set">
										<a href="ecommerce_menu.php" class="btn btn-default btn-circle"><i class="fa fa-angle-left"></i> Back</a>
