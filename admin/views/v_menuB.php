				...
				<div class="col-md-12">
					...
					<div class="portlet light">
						<div class="portlet-title">
							...
							<div class="actions">
								<div class="btn-group">
									<a class="btn btn-default btn-circle" href="ecommerce_menu_edit.php" >
								...
								<tbody>
									<?php
										...
										while($menu = $req->fetch()){
											...
											$type="success";
											if($menu['statut_menu'] == "indisponible"){
												$type="danger";
											}
											echo '<tr role="row" class="'.$class.'">
												<td><div class="group-checkable"><span><input type="checkbox" name="id[]" value="1"></span></div></td>
												<td class="sorting_1">'.$menu['id_menu'].'</td>
												<td>'.$menu['nom_menu'].'</td>
												<td>'.$menu['prix_menu'].'</td>
												<td>'.$menu['date_menu'].'</td>
												<td><span class="label label-sm label-'.$type.'">'.$menu['statut_menu'].'</span></td>
												<td><a href="ecommerce_menu_edit.php?id='.$menu['id_menu'].'" class="btn btn-xs default btn-editable"><i class="fa fa-pencil"></i> Editer</a></td>
											</tr>';
										}
									?>
								</tbody>
