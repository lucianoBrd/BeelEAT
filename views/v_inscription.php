...
<div class="main">
  ...
  <section class="module module-video bg-dark-30" data-background="assets/images/section-1.jpg">
    ...
    <div class="video-player" data-property="{videoURL:'https://youtu.be/i4Llz617ovY', containment:'.module-video', startAt:0, mute:true, autoPlay:true, loop:true, opacity:1, showControls:false, showYTLogo:false, vol:25}"></div>
  </section>
